...
gamesCard.innerHTML = `${totalg.toLocaleString()}`;
...
const unfundedGames = GAMES_JSON.filter((game) => game.pledged < game.goal);
const unfundedGamesCount = unfundedGames.reduce((count, game) => count + 1, 0);
...
const unfundedGamesString =
  unfundedGamesCount === 0
    ...
    : `There ${
        ...
        unfundedGamesCount === 1 ? "unfunded game" : "unfunded games"
      }.`;
